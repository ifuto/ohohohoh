...
| pipe | 総時間 | 再構築バイト |
|---|---|---|
| A Vanilla系 (32B + smooth AO) | 84.7 ms | 168,887,936 |
| B Sodium系 (20B + 遮蔽再計算) | 276.9 ms | 105,554,960 |
| C Rsift (12B + dedup + Tipsify) | **825.2 ms** (旧 1.266 s → wave 213 HJ) | **24,511,704** |
...
|---|---|---|
| A Vanilla系 | 35.35 ms | 28 |
| B Sodium系 | 37.00 ms | 27 |
| C Rsift | **36.49 ms** (旧 67.3 ms → wave 213 HJ) | 27 |

speedup vs A: 0.96x (B), **0.97x (C)** (旧 0.54x — wave 212 + wave 213 の実測で
C は単一スレッド合成でもバニラ系と実質互角に到達)
